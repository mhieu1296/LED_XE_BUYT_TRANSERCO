...
//   // Load routes.json
//   // Load dữ liệu từ API Flask
//   fetch("http://127.0.0.1:5000/api/tuyen")
//     .then(response => {
//       if (!response.ok) throw new Error("Không tải được API");
//       return response.json();
//     })
//     .then(data => {
//       routesData = data;   // giống hệt cách bạn dùng JSON cũ
//     })
//     .catch(error => console.error("Lỗi load API:", error));
